...
namespace TesteDBs.Models
{
    public class Clientes
    {
        ...
        [ForeignKey(nameof(Marcacoes))]  // esta 'anotação' indica que o atributo 'marcacaoFK' está a executar o mesmo que o atributo 'IdMarcacao',
        ...
        public Marcacoes IdMarcacao { get; set; }   // atributo para ser usado no C#. Representa a FK para a Marcacao do Cliente
